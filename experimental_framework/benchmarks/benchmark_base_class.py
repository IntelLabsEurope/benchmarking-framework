...
class BenchmarkBaseClass(object):
    ...
    One of them will be the calculation of the throughput changing the configuration parameters
    '''
    ...
    def get_features(self):
        features = dict()
        features['description'] = 'Please implement the method "get_features" for your benchmark'
    ...
    def run(self):
        """
        This method executes the specific benchmark on the VNF already instantiated
        :return: list of dictionaries (every dictionary contains the results of a data point
        """
        raise NotImplementedError("Subclass must implement abstract method")
